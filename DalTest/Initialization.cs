...
private static void creatTask()
{
        ...
        {
            s_dalTask!.Create(new Task(0, 0, TaskNamePainter[i], TaskDescriptionForPainter[i], false, start.AddDays(s_rand.Next(rangStart)), null, null, null, null, null, TaskResultForPainter[i], (DO.Expirience)2));
        }
        for (int i = 0; i < TaskNameArchitect.Length; i++)
        {
            s_dalTask!.Create(new Task(0, 0, TaskNameArchitect[i], TaskDescriptionForArchitect[i], false, start.AddDays(s_rand.Next(rangStart)), null, null, null, null, null, TaskResultForArchitect[i], (DO.Expirience)3));
        }
        for (int i = 0; i < TaskNameInteriorDesigner.Length; i++)
        {
            s_dalTask!.Create(new Task(0, 0, TaskNameInteriorDesigner[i], TaskDescriptionForInteriorDesigner[i], false, start.AddDays(s_rand.Next(rangStart)), null, null, null, null, null, TaskResultForInteriorDesigner[i], (DO.Expirience)4));
        }
    ...
    private static void creatWorker()
    {
        ...
        s_dalWorker.Create(new Worker(035423456, 5000, (DO.Expirience)1, "Muchamad Abu Chasan", "muchamad0@gmail.com"));
        s_dalWorker.Create(new Worker(467893456, 5000, (DO.Expirience)1, "Muchamad Chabud", "muchamad0000@gmail.com"));
        s_dalWorker.Create(new Worker(780943567, 15000, (DO.Expirience)2, "Shlomo Ben Chaim", "Shlomo345@gmail.com"));
        s_dalWorker.Create(new Worker(345792615, 25000, (DO.Expirience)3, "Eden Chason", "Eden1212@gmail.com"));
    ...
    private static void creatDependency()
{
        ...
        s_dalDependency!.Create(new Dependency(0, 1, 25));
        s_dalDependency!.Create(new Dependency(0, 1, 26));
        s_dalDependency!.Create(new Dependency(0, 23, 4));
        s_dalDependency!.Create(new Dependency(0, 23, 7));
        s_dalDependency!.Create(new Dependency(0,24, 3));
        s_dalDependency!.Create(new Dependency(0, 24, 8));
        s_dalDependency!.Create(new Dependency(0, 25, 5));
        s_dalDependency!.Create(new Dependency(0, 25, 9));
        s_dalDependency!.Create(new Dependency(0, 26, 2));
        s_dalDependency!.Create(new Dependency(0, 26, 6));
        s_dalDependency!.Create(new Dependency(0, 4, 28));
        s_dalDependency!.Create(new Dependency(0, 7, 10));
        s_dalDependency!.Create(new Dependency(0, 3, 30));
        s_dalDependency!.Create(new Dependency(0, 8, 12));
        s_dalDependency!.Create(new Dependency(0, 5, 29));
        s_dalDependency!.Create(new Dependency(0, 9, 13));
        s_dalDependency!.Create(new Dependency(0, 2, 27));
        s_dalDependency!.Create(new Dependency(0, 6, 11));
        s_dalDependency!.Create(new Dependency(0,12, 21));
        s_dalDependency!.Create(new Dependency(0, 10, 19));
        s_dalDependency!.Create(new Dependency(0, 13, 22));
        s_dalDependency!.Create(new Dependency(0, 11, 20));
        s_dalDependency!.Create(new Dependency(0, 21, 30));
        s_dalDependency!.Create(new Dependency(0, 19, 28));
        s_dalDependency!.Create(new Dependency(0, 22, 29));
        s_dalDependency!.Create(new Dependency(0, 20, 27));
        s_dalDependency!.Create(new Dependency(0, 21, 34));
        s_dalDependency!.Create(new Dependency(0, 19, 31));
        s_dalDependency!.Create(new Dependency(0, 22, 33));
        s_dalDependency!.Create(new Dependency(0, 20, 32));
        s_dalDependency!.Create(new Dependency(0, 23, 16));
        s_dalDependency!.Create(new Dependency(0, 24, 15));
        s_dalDependency!.Create(new Dependency(0, 25, 17));
        s_dalDependency!.Create(new Dependency(0, 26, 14));
        s_dalDependency!.Create(new Dependency(0, 16, 19));
        s_dalDependency!.Create(new Dependency(0, 14, 20));
        s_dalDependency!.Create(new Dependency(0, 15, 21));
        s_dalDependency!.Create(new Dependency(0, 17, 22));
        s_dalDependency!.Create(new Dependency(0, 18, 31));
        s_dalDependency!.Create(new Dependency(0, 18, 32));
